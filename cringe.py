...
GYRO_FULL_SCALE_RANGE_DPS = 125
GYRO_RESOLUTION = 0.00875  # mdps/digit
...
try:
    while True:
        ...
        x_acc_mps2 = x_acc * 9.81
        y_acc_mps2 = y_acc * 9.81
        z_acc_mps2 = z_acc * 9.81

         # Offset Accelerometer values
        x_acc_mps2 += 588.6
        y_acc_mps2 += 637.35
        z_acc_mps2 -= 10271
