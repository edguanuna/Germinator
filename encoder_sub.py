...
def callback(message):
    ...
    print("DistanceA: " + message.distanceA + ", DistanceB: " + message.distanceB + ", Sent at: " + str(message.timestamp) + ", Received at: " + str(rospy.get_time()))
...
def listener():
    ...
    rospy.Subscriber('encoder', TimeDist, callback)
