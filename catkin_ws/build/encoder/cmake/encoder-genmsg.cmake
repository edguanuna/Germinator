...
set(MSG_I_FLAGS "-Iencoder:/home/germinator/Downloads/Germinator/catkin_ws/src/encoder/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/germinator/Downloads/Germinator/catkin_ws/src/encoder/msg/TimeDist.msg" NAME_WE)
add_custom_target(_encoder_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "encoder" "/home/germinator/Downloads/Germinator/catkin_ws/src/encoder/msg/TimeDist.msg" ""
)
...
_generate_msg_cpp(encoder
  "/home/germinator/Downloads/Germinator/catkin_ws/src/encoder/msg/TimeDist.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/encoder)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/encoder\")")
  # install generated code
  install(
